...
BATCH_SIZE = 10
DATA_DIRECTORY = '/tmp3/haowei/Dataset'
DATA_LIST_PATH = './mix_dataset/train.txt'
INPUT_SIZE = '321,321'
LEARNING_RATE = 2.5e-3  #default=2.5e-4
MOMENTUM = 0.9
NUM_STEPS = 20001
POWER = 0.9
RANDOM_SEED = 9487
...
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 500
SNAPSHOT_DIR = './mixD_pascal_b10_lr25e3_sd9487/'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    vars_restore_gist = [v for v in tf.global_variables() if not 'fc' in v.name and not 'mod_conv1' in v.name] # Restore everything but last layer
    ...
    c4_conv1 = [v for v in tf.global_variables() if 'mod_conv1/weights' in v.name][0]
